...
const DealCard: React.FC<DealCardProps> = ({ title, image, category, price }) => {
  return (
    <div className="flex flex-col items-center gap-4 relative p-4 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] hover:shadow-[0_3px_10px_rgb(0,0,0,0.2)] transition-all duration-300 h-[350px]">
